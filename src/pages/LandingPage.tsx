...
const allNavigationTiles = [
    ...
    { title: 'Assets', description: 'Movable assets & rentals', icon: Package, iconBg: 'bg-indigo-50 dark:bg-indigo-900/50', iconColor: 'text-indigo-600 dark:text-indigo-300', badge: null, link: '/assets', resource: 'assets' as ResourceType },
