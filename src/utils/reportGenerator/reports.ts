...
const addHeader = (doc: jsPDF, type: string, startDate: Date, endDate: Date) => {
  doc.setFontSize(20);
  ...
  try {
    switch (type) {
      case 'contributions': {
        ...
        doc.setFontSize(14);
        doc.text('Detailed Contributions', 20, (doc as any).lastAutoTable.finalY + 20);
        ...
        autoTable(doc, {
          ...
          body: contributionsData as RowInput[],
          theme: 'striped',
          headStyles: { fillColor: [79, 70, 229] },
          didDrawPage: () => {
